...
credentials-file: /Users/cheng80/.cloudflared/<TUNNEL_ID>.json
...
```bash
cloudflared tunnel --config /Users/cheng80/.cloudflared/chatbot-rag-test.yml run chatbot-rag-test
```
